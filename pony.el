...
(defvar pony-minor-mode-map
  (let ((map (make-keymap)))
    map))
(pony-key "\C-c\C-db" 'pony-browser)
(pony-key "\C-c\C-dd" 'pony-db-shell)
(pony-key "\C-c\C-df" 'pony-fabric)
(pony-key "\C-c\C-dgt" 'pony-goto-template)
(pony-key "\C-c\C-dgs" 'pony-goto-settings)
(pony-key "\C-c\C-dr" 'pony-runserver)
(pony-key "\C-c\C-dm" 'pony-manage)
(pony-key "\C-c\C-ds" 'pony-shell)
(pony-key "\C-c\C-d!" 'pony-shell)
(pony-key "\C-c\C-dt" 'pony-test)
(pony-key "\C-c\C-d\C-r" 'pony-reload-mode)
